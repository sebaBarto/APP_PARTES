...
function parsearLibroCronograma(XLSX, workbook) {
  ...
  workbook.SheetNames.forEach((nombre) => {
    const tareasHoja = parsearHojaCronograma(XLSX, workbook.Sheets[nombre], nombre);
